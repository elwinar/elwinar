...
func srcViewsLayoutHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/views/layout.html", size: 1646, mode: os.FileMode(420), modTime: time.Unix(1488021857, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func srcViewsUncssHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "src/views/uncss.html", size: 940, mode: os.FileMode(420), modTime: time.Unix(1488021857, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
