...
func ViewsFortuneHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "../views/fortune.html", size: 154, mode: os.FileMode(420), modTime: time.Unix(1444377443, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
